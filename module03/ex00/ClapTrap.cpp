...
{
	std::cout << YELLOW << "ClapTrap [" << this->_name << "] was created." << DEFAULT << std::endl;
}
...
{
	std::cout << YELLOW << "ClapTrap [" << this->_name << "] was copied." << DEFAULT << std::endl;
}
